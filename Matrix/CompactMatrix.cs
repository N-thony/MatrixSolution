...
namespace Matrix
{
    ...
    public class CompactMatrix
    {
        ...
        /// </summary>
        /// <param name="sparseMatrix">The input sparse matrix.</param>
        /// <returns>A CompactMatrix instance.</returns>
        ...
        /// <summary>
        /// Gets the compact matrix.
        /// </summary>
        /// <returns>The compact matrix.</returns>
